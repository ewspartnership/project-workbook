  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '56px 32px 80px' }}>
      ...
      <p style={{ fontSize: 18, color: '#5A5249', lineHeight: 1.6, marginBottom: 12 }}>
        This workbook isn't a methodology — it's a thinking shape that draws together three strands of practice that, in my experience, charity teams need together but rarely get.
      </p>
      ...
      <section style={{ marginBottom: 48 }}>
        ...
        <ul style={{ fontSize: 15, lineHeight: 1.85, color: '#3D3933', paddingLeft: 24 }}>
          ...
          <li>choosing indicators that audit power, not just count things</li>
      ...
      <section style={{ marginBottom: 48 }}>
        ...
        <p style={{ fontSize: 15, color: '#3D3933', lineHeight: 1.65, marginBottom: 12 }}>
          The version you're using is a working prototype, deliberately scoped for a single user trying it out. Two pieces of the picture aren't built yet, and they matter:
        </p>
        <ul style={{ fontSize: 15, lineHeight: 1.85, color: '#3D3933', paddingLeft: 24 }}>
          <li><strong>Team-shared data and partner collaboration.</strong> Right now projects live in the browser of whoever opened them. For a real charity team &mdash; covering mat leave, picking up someone else's project, knowing who's doing what &mdash; projects need to live somewhere shared. The same backend would also support a smoother round-trip with external partners: today, partners can edit the exported Word doc and email it back to be re-keyed; the next version would let them work directly on the live project (read-only or edit), and bring partner-edited Word documents back in automatically. Not a rewrite &mdash; a sensible extension.</li>
          <li><strong>Proposal upload &amp; auto-fill.</strong> Most projects begin with an email or a bid document landing in someone's inbox. The next version will let users paste or upload that source and have the workbook extract what it can — problem, target group, budget, dates — and flag clearly what's still missing as questions for the Project Lead. This turns the design stage from "stare at the blank form" into "review and refine what's already there."</li>
        </ul>
        <p style={{ fontSize: 15, color: '#3D3933', lineHeight: 1.65, marginTop: 12, fontStyle: 'italic' }}>
          Both are deliberate omissions from this version, not gaps. The shape of the workbook is what needed to be right first.
        </p>
      </section>
